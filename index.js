...
const url = 'https://hooks.slack.com/services/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'
const webhook = new IncomingWebhook(url);

//check the time and see if we should send a quote out
//for now just do it at a fixed time once per day
var shouldSendQuote = true; //actually just using Heroku job scheduler 
...
if (shouldSendQuote) {
    ...
    webhook.send(quote, function(err, res) {
        if (err) {
